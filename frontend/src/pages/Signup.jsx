        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 6 }}>
            <div style={{ fontSize: 32, marginBottom: 10,
              filter: "drop-shadow(0 0 14px rgba(255,190,50,0.7))" }}>🌿</div>
            <h2 style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            <div>
              <label style={{
                ...
                textTransform: "uppercase", color: "rgba(195,155,65,0.65)", marginBottom: 8,
              }}>Your Name</label>
              <input className="enchanted-input"
                type="text" name="name" placeholder="Wizard of the North"
            ...
            <div style={{ marginTop: 4 }}>
              <button className="submit-btn" type="submit" disabled={isLoading}>
                {isLoading ? "Weaving your path…" : "🌿 Enter the Forest"}
              </button>
            </div>
          </form>
          ...
          <p style={{ textAlign: "center", color: "rgba(155,120,55,0.6)", fontSize: 14, margin: 0 }}>
            Already a scholar?{" "}
            <Link to="/login" className="login-link">Return to the Hall</Link>
          </p>
        </div>
      </div>
    </div>
